...
proc create_hier_cell_stream { parentCell nameHier } {
  ...
  set pcp [ create_bd_cell -type ip -vlnv xilinx.com:user:myIP2:1.0 pcp ]
  ...
  connect_bd_intf_net -intf_net myIP2_0_M00_AXIS [get_bd_intf_pins dma/S_AXIS_S2MM] [get_bd_intf_pins pcp/M00_AXIS]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_S2MM [get_bd_intf_pins axi_smc/S01_AXI] [get_bd_intf_pins stream/M_AXI_S2MM]
