...
set rc [catch {
  ...
  set_property webtalk.parent_dir B:/COLLEGE/Thesis/Source/IP/MultiplierVivado/MultiplierVivado.cache/wt [current_project]
  set_property parent.project_path B:/COLLEGE/Thesis/Source/IP/MultiplierVivado/MultiplierVivado.xpr [current_project]
  set_property ip_repo_paths B:/COLLEGE/Thesis/Source/IP [current_project]
  update_ip_catalog
  set_property ip_output_repo B:/COLLEGE/Thesis/Source/IP/MultiplierVivado/MultiplierVivado.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
  add_files -quiet B:/COLLEGE/Thesis/Source/IP/MultiplierVivado/MultiplierVivado.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files B:/COLLEGE/Thesis/Source/IP/MultiplierVivado/MultiplierVivado.srcs/sources_1/bd/design_1/design_1.bd
