...
proc create_ipi_design { offsetfile design_name } {
	...
	# Copy all address to my_multiplier_v1_2_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/my_multiplier_v1_2_include.tcl"
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/my_multiplier_v1_2_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "my_multiplier_v1_2_hw_${i}"
