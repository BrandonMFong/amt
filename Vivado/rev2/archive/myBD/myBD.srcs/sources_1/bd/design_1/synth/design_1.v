...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=5,numNonXlnxBlks=0,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=16,da_clkrst_cnt=4,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire [39:0]stream_M_AXI_MM2S_ARADDR;
  wire [1:0]stream_M_AXI_MM2S_ARBURST;
  wire [3:0]stream_M_AXI_MM2S_ARCACHE;
  wire [7:0]stream_M_AXI_MM2S_ARLEN;
  wire [2:0]stream_M_AXI_MM2S_ARPROT;
  wire stream_M_AXI_MM2S_ARREADY;
  wire [2:0]stream_M_AXI_MM2S_ARSIZE;
  wire stream_M_AXI_MM2S_ARVALID;
  wire [31:0]stream_M_AXI_MM2S_RDATA;
  wire stream_M_AXI_MM2S_RLAST;
  wire stream_M_AXI_MM2S_RREADY;
  wire [1:0]stream_M_AXI_MM2S_RRESP;
  wire stream_M_AXI_MM2S_RVALID;
  wire [39:0]stream_M_AXI_S2MM_AWADDR;
  wire [1:0]stream_M_AXI_S2MM_AWBURST;
  wire [3:0]stream_M_AXI_S2MM_AWCACHE;
  wire [7:0]stream_M_AXI_S2MM_AWLEN;
  wire [2:0]stream_M_AXI_S2MM_AWPROT;
  wire stream_M_AXI_S2MM_AWREADY;
  wire [2:0]stream_M_AXI_S2MM_AWSIZE;
  wire stream_M_AXI_S2MM_AWVALID;
  wire stream_M_AXI_S2MM_BREADY;
  wire [1:0]stream_M_AXI_S2MM_BRESP;
  wire stream_M_AXI_S2MM_BVALID;
  wire [31:0]stream_M_AXI_S2MM_WDATA;
  wire stream_M_AXI_S2MM_WLAST;
  wire stream_M_AXI_S2MM_WREADY;
  wire [3:0]stream_M_AXI_S2MM_WSTRB;
  wire stream_M_AXI_S2MM_WVALID;
  ...
  design_1_axi_smc_1 axi_smc
       (.M00_AXI_araddr(axi_smc_M00_AXI_ARADDR),
        ...
        .S01_AXI_wuser(1'b0),
        .S01_AXI_wvalid(1'b0),
        .S02_AXI_araddr(stream_M_AXI_MM2S_ARADDR),
        .S02_AXI_arburst(stream_M_AXI_MM2S_ARBURST),
        .S02_AXI_arcache(stream_M_AXI_MM2S_ARCACHE),
        .S02_AXI_arlen(stream_M_AXI_MM2S_ARLEN),
        .S02_AXI_arlock(1'b0),
        .S02_AXI_arprot(stream_M_AXI_MM2S_ARPROT),
        .S02_AXI_arqos({1'b0,1'b0,1'b0,1'b0}),
        .S02_AXI_arready(stream_M_AXI_MM2S_ARREADY),
        .S02_AXI_arsize(stream_M_AXI_MM2S_ARSIZE),
        .S02_AXI_arvalid(stream_M_AXI_MM2S_ARVALID),
        .S02_AXI_rdata(stream_M_AXI_MM2S_RDATA),
        .S02_AXI_rlast(stream_M_AXI_MM2S_RLAST),
        .S02_AXI_rready(stream_M_AXI_MM2S_RREADY),
        .S02_AXI_rresp(stream_M_AXI_MM2S_RRESP),
        .S02_AXI_rvalid(stream_M_AXI_MM2S_RVALID),
        .S03_AXI_awaddr(stream_M_AXI_S2MM_AWADDR),
        .S03_AXI_awburst(stream_M_AXI_S2MM_AWBURST),
        .S03_AXI_awcache(stream_M_AXI_S2MM_AWCACHE),
        .S03_AXI_awlen(stream_M_AXI_S2MM_AWLEN),
        .S03_AXI_awlock(1'b0),
        .S03_AXI_awprot(stream_M_AXI_S2MM_AWPROT),
        .S03_AXI_awqos({1'b0,1'b0,1'b0,1'b0}),
        .S03_AXI_awready(stream_M_AXI_S2MM_AWREADY),
        .S03_AXI_awsize(stream_M_AXI_S2MM_AWSIZE),
        .S03_AXI_awvalid(stream_M_AXI_S2MM_AWVALID),
        .S03_AXI_bready(stream_M_AXI_S2MM_BREADY),
        .S03_AXI_bresp(stream_M_AXI_S2MM_BRESP),
        .S03_AXI_bvalid(stream_M_AXI_S2MM_BVALID),
        .S03_AXI_wdata(stream_M_AXI_S2MM_WDATA),
        .S03_AXI_wlast(stream_M_AXI_S2MM_WLAST),
        .S03_AXI_wready(stream_M_AXI_S2MM_WREADY),
        .S03_AXI_wstrb(stream_M_AXI_S2MM_WSTRB),
        .S03_AXI_wvalid(stream_M_AXI_S2MM_WVALID),
  ...
  stream_imp_100ZW6D stream
       (.M_AXI_MM2S_araddr(stream_M_AXI_MM2S_ARADDR),
        .M_AXI_MM2S_arburst(stream_M_AXI_MM2S_ARBURST),
        .M_AXI_MM2S_arcache(stream_M_AXI_MM2S_ARCACHE),
        .M_AXI_MM2S_arlen(stream_M_AXI_MM2S_ARLEN),
        .M_AXI_MM2S_arprot(stream_M_AXI_MM2S_ARPROT),
        .M_AXI_MM2S_arready(stream_M_AXI_MM2S_ARREADY),
        .M_AXI_MM2S_arsize(stream_M_AXI_MM2S_ARSIZE),
        .M_AXI_MM2S_arvalid(stream_M_AXI_MM2S_ARVALID),
        .M_AXI_MM2S_rdata(stream_M_AXI_MM2S_RDATA),
        .M_AXI_MM2S_rlast(stream_M_AXI_MM2S_RLAST),
        .M_AXI_MM2S_rready(stream_M_AXI_MM2S_RREADY),
        .M_AXI_MM2S_rresp(stream_M_AXI_MM2S_RRESP),
        .M_AXI_MM2S_rvalid(stream_M_AXI_MM2S_RVALID),
        .M_AXI_S2MM_awaddr(stream_M_AXI_S2MM_AWADDR),
        .M_AXI_S2MM_awburst(stream_M_AXI_S2MM_AWBURST),
        .M_AXI_S2MM_awcache(stream_M_AXI_S2MM_AWCACHE),
        .M_AXI_S2MM_awlen(stream_M_AXI_S2MM_AWLEN),
        .M_AXI_S2MM_awprot(stream_M_AXI_S2MM_AWPROT),
        .M_AXI_S2MM_awready(stream_M_AXI_S2MM_AWREADY),
        .M_AXI_S2MM_awsize(stream_M_AXI_S2MM_AWSIZE),
        .M_AXI_S2MM_awvalid(stream_M_AXI_S2MM_AWVALID),
        .M_AXI_S2MM_bready(stream_M_AXI_S2MM_BREADY),
        .M_AXI_S2MM_bresp(stream_M_AXI_S2MM_BRESP),
        .M_AXI_S2MM_bvalid(stream_M_AXI_S2MM_BVALID),
        .M_AXI_S2MM_wdata(stream_M_AXI_S2MM_WDATA),
        .M_AXI_S2MM_wlast(stream_M_AXI_S2MM_WLAST),
        .M_AXI_S2MM_wready(stream_M_AXI_S2MM_WREADY),
        .M_AXI_S2MM_wstrb(stream_M_AXI_S2MM_WSTRB),
        .M_AXI_S2MM_wvalid(stream_M_AXI_S2MM_WVALID),
...
module stream_imp_100ZW6D
  ...
  wire [39:0]axi_dma_0_M_AXI_S2MM_AWADDR;
  ...
  wire [31:0]myIP2_0_M00_AXIS_TDATA;
  wire myIP2_0_M00_AXIS_TLAST;
  wire myIP2_0_M00_AXIS_TREADY;
  wire myIP2_0_M00_AXIS_TVALID;
  wire processing_system7_0_FCLK_CLK0;
  wire [9:0]ps7_0_axi_periph_M00_AXI_ARADDR;
  wire ps7_0_axi_periph_M00_AXI_ARREADY;
  wire ps7_0_axi_periph_M00_AXI_ARVALID;
  wire [9:0]ps7_0_axi_periph_M00_AXI_AWADDR;
  ...
  assign M_AXI_MM2S_araddr[39:0] = axi_dma_0_M_AXI_MM2S_ARADDR;
  ...
  assign M_AXI_S2MM_awaddr[39:0] = axi_dma_0_M_AXI_S2MM_AWADDR;
  ...
  assign processing_system7_0_FCLK_CLK0 = m00_axis_aclk;
  assign ps7_0_axi_periph_M00_AXI_ARADDR = S_AXI_LITE_araddr[9:0];
  assign ps7_0_axi_periph_M00_AXI_ARVALID = S_AXI_LITE_arvalid;
  assign ps7_0_axi_periph_M00_AXI_AWADDR = S_AXI_LITE_awaddr[9:0];
  ...
  assign rst_ps7_0_100M_peripheral_aresetn = m00_axis_aresetn;
  design_1_axi_dma_0_1 dma
       (.axi_resetn(rst_ps7_0_100M_peripheral_aresetn),
        ...
        .s_axis_s2mm_tdata(myIP2_0_M00_AXIS_TDATA),
        .s_axis_s2mm_tkeep({1'b1,1'b1,1'b1,1'b1}),
        .s_axis_s2mm_tlast(myIP2_0_M00_AXIS_TLAST),
        .s_axis_s2mm_tready(myIP2_0_M00_AXIS_TREADY),
        .s_axis_s2mm_tvalid(myIP2_0_M00_AXIS_TVALID));
  design_1_myIP_0 myIP
       (.m00_axis_aclk(processing_system7_0_FCLK_CLK0),
        .m00_axis_aresetn(rst_ps7_0_100M_peripheral_aresetn),
        .m00_axis_tdata(myIP2_0_M00_AXIS_TDATA),
        .m00_axis_tlast(myIP2_0_M00_AXIS_TLAST),
        .m00_axis_tready(myIP2_0_M00_AXIS_TREADY),
        .m00_axis_tvalid(myIP2_0_M00_AXIS_TVALID),
