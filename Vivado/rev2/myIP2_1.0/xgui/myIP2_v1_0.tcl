...
proc validate_PARAM_VALUE.bitNumber { PARAM_VALUE.bitNumber } {
	# Procedure called to validate bitNumber
	return true
}
...
proc update_MODELPARAM_VALUE.bitNumber { MODELPARAM_VALUE.bitNumber PARAM_VALUE.bitNumber } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.bitNumber}] ${MODELPARAM_VALUE.bitNumber}
}
